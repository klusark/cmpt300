...
in the opposite direction. The SSTF algorithm will move the IO head to the desired
...
are requested. Since the IO head moved down from 10 to 6, we know the current direction is
